...
@Component({
  selector: 'app-alice2',
  templateUrl: './alice2.component.html',
  styleUrls: ['./alice2.component.css']
})
export class Alice2Component implements OnInit {

  englishContent: string[] = ["Definition of diffcult words", "Posted on August 28, 2019 by The 100 precent", "Definition of diffcult words", "Posted on August 28, 2019 by The 100 precent",
    ...
    "More information", "How many work classifications are there?", "Posted on August 28, 2019, The 100 precent", "Next  ->", "<-  Back", "Go to Decision Maker  ->"];
  chineseContent: string[] = ["相关名词的定义", "发布于 8/28, 2019。作者：100%", "相关名词的定义", "发布于 8/28, 2019。作者：100%",
    ...
    "更多文章", "有多少工作分类?", "发布于 8/28, 2019。作者：100%", "下一步", "后退", "前往决策帮助"];
  showContent: string[] = [];
